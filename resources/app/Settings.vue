    ...
    <main-layout>
        <div class="max-w-[1200px] mx-auto flex flex-wrap db-settings px-4">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>Status: {{ xero_status }}</div>

                <div v-if="xero_expiry">Auth Expiry: {{ xero_expiry }}</div>
            </div>
...
<script setup lang="ts">
    ...
    const xero_status = ref("")
    const xero_expiry = ref("")
    ...
    const refreshSettings = async () => {
        ...
        xero_status.value = data.xero_status
        xero_expiry.value = data.xero_expiry
