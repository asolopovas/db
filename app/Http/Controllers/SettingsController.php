...
class SettingsController extends CrudController
{
    ...
    public function getSettings()
    {
        ...
        $xeroTokenRecord = Cache::get('xero_token');
        $connected = Cache::has("xero_access_token");
        $data['xero_status']   = $connected ? 'connected' : 'not connected';
        if ($connected) {
            $data['xero_expiry']   = $xeroTokenRecord ?  Carbon::parse($xeroTokenRecord['reauthenticate_at'])->format('d M Y H:i:s') : 'N/A';
        }
